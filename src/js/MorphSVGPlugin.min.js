                ...
                (!i || a.test(e) || (e.match(R) || []).length < 3) &&
                    ((n = i ? p.selector(e) : e && e[0] ? e : [e]) && n[0]
                        ? ((o = ((n = n[0]).nodeName + "").toUpperCase()),
                          ...
                          (e =
                              n.getAttribute("PATH" === o ? "d" : "points") ||
                              ""),
                          n === r &&
                              (e =
                                  n.getAttributeNS(null, "data-original") || e))
        ...
        ne = _gsScope._gsDefine.plugin({
            ...
            init: function (e, t, r, n) {
                ...
                if (
                    ...
                    return (
                        Y("WARNING: cannot morph a <" + o + "> element. " + re),
                        !1
                    );
                if (
                    ((i = "PATH" === o ? "d" : "points"),
                ...
                if (
                    ...
                    (this._apply =
                        "updateTarget" in t
                            ? t.updateTarget
                            : ne.defaultUpdateTarget),
                    (this._rnd = Math.pow(
                        10,
                        isNaN(t.precision) ? 2 : +t.precision
                    )),
                    (this._tween = r),
                    h)
                ) {
            ...
            set: function (e) {
                var t,
                    ...
                    y = this._target;
                if (
                    (this._super.setRatio.call(this, e), 1 === e && this._apply)
                )
                    ...
                    for (r = e < 0.5 ? 2 * e * e : (4 - 2 * e) * e - 1; d; )
                        (c =
                            (h = d.i) +
                            (h === (o = u[d.j]).length - 4 ? 7 - o.length : 5)),

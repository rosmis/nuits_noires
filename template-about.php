...
<section class="about-wrapper trigger-footer about-blurred">
    ...
    <div class="brand-showcase">
        ...
        <a href="https://nuitsnoires.com/realisations/marque/salomon/" class="brand-wrapper middle">
            ...
            <img src="<?php echo get_template_directory_uri(). '/src/assets/brands/salomon_marketing_immersif.webp'?>" loading=lazy alt="logo musee quai branly jacques chirac">
        </a>
    ...
    <div class="test-rotate-circle"></div>
</section>

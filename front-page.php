    ...
    <div class="sea-wrapper video-container sea-wrapper-0" style="z-index: 4">
        ...
        <div class="svg-trigger">
            <svg xmlns="http://www.w3.org/2000/svg" width="83" height="71" viewBox="0 0 83 71">
                <path id="outer_triangle" data-name="Polygone 3" d="M41.5,1.982,1.743,70H81.257L41.5,1.982M41.5,0,83,71H0Z" transform="translate(83 71) rotate(180)" fill="#fff"/>
                ...
                <path id="inner_triangle" data-name="Polygone 2" d="M26.5,1.971,1.749,44h49.5L26.5,1.971M26.5,0,53,45H0Z" transform="translate(68 52) rotate(180)" fill="#fff"/>
                <path id="inner_circle" data-name="Polygone 2" style="visibility: hidden" d="M26.5,15.7a14.148,14.148,0,1,0,12.191,6.969A14.02,14.02,0,0,0,26.5,15.7m0-1a15.148,15.148,0,1,1-13.053,7.461A15.011,15.011,0,0,1,26.5,14.7Z" transform="translate(41.671 45) rotate(180)" fill="#fff"/>
            </svg>

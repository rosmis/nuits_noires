...
<div class="realisations-wrapper">
    ...
    <div class="category-wrapper" style="background-image: url(http://localhost:10043/wp-content/uploads/2023/07/realisations.png); z-index: 1; opacity: 1">                 
    ...
    <div class="category-wrapper" style="background-image: url(http://localhost:10043/wp-content/uploads/2023/07/marque.png); z-index: 0; opacity: 0">                 
    ...
    <div class="category-wrapper" style="background-image: url(http://localhost:10043/wp-content/uploads/2023/07/art_vivant.png); z-index: 0; opacity: 0">                 
    ...
    <div class="category-wrapper" style="background-image: url(http://localhost:10043/wp-content/uploads/2023/07/patrimoine.png); z-index: 0; opacity: 0">                 
